...
export const env = createEnv({
  server: {
    ...
    COS_REGION: z.string().default('ap-beijing').optional(),
    COS_SECRET_ID: z.string().min(1).optional(),
    COS_SECRET_KEY: z.string().min(1).optional(),
    COS_BUCKET: z.string().min(1).optional(),
    COS_PREFIX: z.string().default('').optional(),
    COS_CUSTOM_DOMAIN: z.string().default('').optional(),
    COS_EXCLUDE_REGEX: z.string().optional(),
